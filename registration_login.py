...
root = Tk()
root.title("Python: Registeration Form")
...
def Login():
    ...
    if USERNAME.get == "" or PASSWORD.get() == "":
        ...
        if cursor.fetchone() is not None:
            ...
            Label(master, text="Welcome", bg="blue", fg="Black", font="Castellar").pack()
            s = USERNAME.get()
            Label(master, text=s, bg="blue", fg="Black", font="Castellar").pack()
            master.mainloop()
        else:
